...
import pandas as pd
import os
os.chdir('GPindep/inclass/Day2_IntroGP/')
...
#TODO: figure out how to run a Stan model, and replicate the LA analysis in the paper in Stan and using MLE and compare
